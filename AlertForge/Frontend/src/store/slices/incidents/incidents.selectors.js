...
export const selectIncidentCounts = (state) => {
  const list = state.incidents.list;
  return {
...
export const selectActiveIncidents = (state) =>
  state.incidents.list.filter((i) => i.status !== "Resolved");